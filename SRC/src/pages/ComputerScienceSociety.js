import styles from "./ComputerScienceSociety.module.css";

const ComputerScienceSociety = () => {
  return (
    <div className={styles.computerScienceSociety}>
      ...
      <div className={styles.navDiv}>
        ...
        <div className={styles.infoLoginDiv}>
          ...
          <div className={styles.emailDiv}>
            ...
            <img className={styles.call1Icon} alt="" src="../call-111.svg" />
          </div>
      ...
      <div className={styles.bannerDiv}>
        ...
        />
        <b className={styles.tUDublinSocieties}>TU Dublin Societies</b>
      </div>
      <div className={styles.joiningAndParticipatingInA}>
        Joining and participating in a society will provide you with lasting
        memories of college life. Active participation in societies gives you a
        great social outlet. So make the effort and join a society - you'll be
        glad you did.
      </div>
      <div className={styles.div1}>
        ...
        <a
          className={styles.a}
          href="https://www.tudublin.ie/socsportal/profile.php?id=MTA2NQ=="
          target="_blank"
        >
...
export default ComputerScienceSociety;
