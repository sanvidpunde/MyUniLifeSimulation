...
server.use((req, res, next) => {
	res.setHeader('Access-Control-Allow-Origin', 'https://my-uni-life-simulation.vercel.app');
...
// Use public folder as static server commented as we do not need static host
