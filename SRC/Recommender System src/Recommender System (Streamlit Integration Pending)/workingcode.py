...
location = "Dublin"#request.form["location"]
interest = "Applications Developer"#request.form["interest"]
job_domain=  "IT"#request.form["job_domain"]
personality= "serious"#request.form["personality"]
